...
st.sidebar.markdown("This dashboard allows you analyse trending youtube using python and Streamlit")
st.sidebar.markdown("To get started <ol><li>Enter the <i> search</i> you wish to analyse </li> <li> Get data </i><li> Get analyse</ol>", unsafe_allow_html=True)
...
if st.button('Get data'):
    ...
    if get_data:
        ...
        fig4 = px.pie(df, values=df['View Count:'], names='Country', title='Population of European continent')
